...
<div class="vendor-profile-container">
        ...
        <div class="profile-section">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card" style="border-left-color: #28a745;">
                    <div class="stat-value" style="color: #28a745;"><?php echo $stats['orders_count']; ?></div>
                    <div class="stat-label">Órdenes</div>
                </div>
                <div class="stat-card" style="border-left-color: #ffc107;">
                    <div class="stat-value" style="color: #ffc107;">$<?php echo number_format($stats['total_sales'], 0); ?></div>
                    <div class="stat-label">Ventas Totales</div>
                </div>
                <div class="stat-card" style="border-left-color: #17a2b8;">
                    <div class="stat-value" style="color: #17a2b8;"><?php echo date('d/m/Y', strtotime($user['created_at'])); ?></div>
        ...
        <form method="POST" action="/mostrador/vendor/perfil-actualizar">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="help-text">Tu nombre completo como aparecerá para los clientes</div>
                </div>
                <div class="form-group">
                    <label for="email">Correo Electrónico</label>
                    <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($user['email']); ?>" required>
                    <div class="help-text">Tu correo para contacto y recuperación de cuenta</div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="help-text">Dirección para coordinación de pedidos</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="help-text">Teléfono de contacto</div>
            </div>

            <div class="form-group">
                <label for="descripcion">Descripción de tu Negocio (Opcional)</label>
                <textarea id="descripcion" name="descripcion" placeholder="Cuéntanos sobre tu tienda, especialidad, años de experiencia, etc."><?php echo htmlspecialchars($user['descripcion'] ?? ''); ?></textarea>
                <div class="help-text">Información que verán los clientes sobre tu negocio (máx. 500 caracteres)</div>
            </div>
    ...
    <div class="profile-section">
        ...
        <p style="color: #6c757d; font-size: 14px; margin-bottom: 15px;">
            ...
            ✓ Se registran los intentos fallidos de acceso a tu cuenta<br>
            ✓ Se auditan todos los cambios en tu perfil y productos
        </p>
